...
if($auth['ArtistID'] != NULL){
    header('Location: /dashboard/singer');
    die();
}
...
<div class="col-xl-9">
    <div class="main-content-area p-lg-6 p-4 rounded bgc-2 border-full">
        <div class="create-podcast-area p-lg-6 p-sm-4 p-2 rounded-3 border-full bc-500 bgc-4">
            ...
            <form submit-ajax="duogxaolin" action="/api/auth/create" class="d-grid gap-sm-6 gap-4 d-nonge" method="POST">
                <div class="d-flex flex-column flex-sm-row align-items-sm-center gap-lg-6 gap-4">
                    <div class="input-wrapper d-grid gap-lg-4 gap-2 w-100">
                        ...
                        <input type="text" name="title" placeholder="Tên/Nghệ Danh" wfd-id="id1">
                    </div>
                    <div class="input-wrapper d-grid gap-lg-4 gap-2">
                        ...
                        <input type="number" name="year" placeholder="Sinh Nhật" wfd-id="id2">
