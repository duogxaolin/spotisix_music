        ...
        <div class="container pt-120 pb-120">
            <div class="row g-6 justify-content-between">
                <div class="col-lg-6">
                    ...
                    <form submit-ajax="duogxaolin" action="/api/auth/login" class="auth-form p-xl-8 p-4 bgc-2 rounded" method="POST">
                            ...
                            <div class="mt-4 mb-lg-10 mb-sm-8 mb-6">
                                <a href="/forgot-password" class="forgot-password d-block text-end fw-normal">Forgot Password?</a>
                                <p>Don’t have an account? <a href="/register" class="tcp-1">Sign Up</a></p>
                            </div>
